...
concurrency::task<std::shared_ptr<api::PlaylistResume>> playlists::getPlaylistAsync(const std::wstring & idRef, concurrency::cancellation_token cancelToken, bool forceRefresh )
{
...
concurrency::task<std::shared_ptr<api::PaginatedList<api::TrackInfo>>> playlists::getPlaylistTracksAsync(const std::wstring & idRef, int trackCount, concurrency::cancellation_token cancelToken, bool forceRefresh )
{
	std::wstring id = idRef;
