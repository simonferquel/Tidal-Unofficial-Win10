...
concurrency::task<void> FavoritesService::refreshAsync()
{
	...
	if (!authState.isAuthenticated()) {
		...
		auto albumsTask = api::GetFavoriteAlbumsQuery(authState.userId(), authState.sessionId(), authState.countryCode()).executeAsync(concurrency::cancellation_token::none());
		auto artistsTask = api::GetFavoriteArtistsQuery(authState.userId(), authState.sessionId(), authState.countryCode()).executeAsync(concurrency::cancellation_token::none());
		auto tracksTask = api::GetFavoriteTracksQuery(authState.userId(), authState.sessionId(), authState.countryCode()).executeAsync(concurrency::cancellation_token::none());
		auto playlistsTask = api::GetFavoritePlaylistsQuery(authState.userId(), authState.sessionId(), authState.countryCode()).executeAsync(concurrency::cancellation_token::none());
		auto myPlaylistsTask = api::GetMyPlaylistsQuery(authState.userId(), authState.sessionId(), authState.countryCode()).executeAsync(concurrency::cancellation_token::none());
